...
export default async function FilmPage({ searchParams }: PageProps) {
  ...
  const { results, totalPages, totalItems } = getPaginated("film", currentPage, 24, currentSort);
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-900 pb-6 mb-6">
          <div>
            ...
            <div className="text-xs text-zinc-500 mb-2 flex items-center gap-1.5 font-medium">
              ...
              <span>&gt;</span>
              <span className="text-zinc-350">Film</span>
            </div>
            <h1 className="text-3xl font-extrabold text-white tracking-tight">Daftar Film</h1>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href="/film" className="bg-indigo-600 text-white font-bold px-4 py-2.5 rounded-lg text-xs shadow-md shadow-indigo-600/20">
              Film
            </Link>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex flex-wrap gap-1.5">
              {[
                ...
                <Link
                  key={opt.value}
                  href={`/film?sort=${opt.value}&page=1`}
